            ...
            <div className="bg-[#111] border border-white/[0.06] rounded-2xl p-8 shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
              {success ? (
                ...
                <>
                  ...
                  {error && (
                    <div
                      className="mb-4 p-3 bg-red-500/10 border border-red-500/30 rounded-xl text-red-400 text-center"
                      style={{
                        fontSize: "13px",
                        fontFamily: "Inter, sans-serif",
                      }}
                  ...
                  <div className="mt-6 pt-6 border-t border-white/[0.06] text-center">
                    ...
                    {cooldown > 0 ? (
                      ...
                      >
                        Resend available in{" "}
                        <span className="text-[#eb7524]/70 font-medium">
                          {cooldown}s
                        </span>
                      </p>
                    ) : (
