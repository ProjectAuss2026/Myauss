      ...
      <div className="auth-card">
        ...
        {step === 'register' ? (
          <form onSubmit={handleRegister} className="auth-form">
            <label>
              Email
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="you@auckland.ac.nz" required />
            </label>
            <label>
              Password
          ...
          <form onSubmit={handleVerify} className="auth-form">
            ...
            <button type="button" className="secondary auth-btn" onClick={handleResend} disabled={cooldown > 0}>
